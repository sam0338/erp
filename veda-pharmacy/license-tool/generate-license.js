#!/usr/bin/env node
// ============================================================
// VEDA Pharmacy — License Key Generator
...
// stores where you control the install yourself. For a key you're selling
// to someone else, ask them for the "Installation ID" shown on their
// License page/tab first, and pass it as --fingerprint so the key only
